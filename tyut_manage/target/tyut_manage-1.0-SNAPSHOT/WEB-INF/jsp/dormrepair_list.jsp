...
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.tyut.po.DormRepair" %>
    ...
    <div class="layui-row" id="test" style="display: none;">
        <div class="layui-col-md10">
            <form class="layui-form" id="addEmployeeForm">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">报修费用：</label>
                    <div class="layui-input-block">
                        <input type="text" name="reason" class="layui-input" placeholder="请输入报修费用">
                    </div>
                </div>
            ...
            form.on('submit(toolbarDemo)', function(){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        // 2. 数组头部新增表头
                        dt.unshift({r_id: 'ID', d_id: '宿舍编号', d_dormbuilding: '宿舍楼', r_name: '维修人员', reason: '报修事由', money: '报修费用', create_time: '报修时间', update_time: '更新时间'});
