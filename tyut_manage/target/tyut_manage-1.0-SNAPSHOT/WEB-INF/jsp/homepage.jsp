...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="#">TYUT宿舍管理系统</a></div>
    <div class="left_open">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:;"><img src="images/6.jpg" class="layui-nav-img">${sessionScope.ad.a_username}</a>
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content" >
            <div class="layui-tab-item layui-show o_div" >
                <span class="o_span">${sessionScope.ad.a_username}管理员，欢迎来到TYUT宿舍管理系统！</span>
...
<!-- 底部开始 -->
<div class="footer">
    <div class="copyright">TYUT宿舍管理系统</div>
</div>
<!-- 底部结束 -->
